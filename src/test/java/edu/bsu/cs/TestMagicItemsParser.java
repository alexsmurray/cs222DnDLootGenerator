...
public class TestMagicItemsParser {
    ...
    public void testGetMagicItemNameFromSampleJson() {
        JSONArray sampleJsonArray = testMagicParser.parseMagicItemName(0);
    ...
    public void testGetRarityFromSampleJson() {
        JSONArray sampleJsonArray = testMagicParser.parseMagicItemRarity( 0);
    ...
    public void testGetTypeFromSampleJson() {
        JSONArray sampleJsonArray = testMagicParser.parseMagicItemType(0);
    ...
    public void testGetAttunementFromSampleJson() {
        JSONArray sampleJsonArray = testMagicParser.parseMagicItemAttunement(0);
    ...
    public void testGetDescriptionFromSampleJson() {
        JSONArray sampleJsonArray = testMagicParser.parseMagicItemDescription(0);
