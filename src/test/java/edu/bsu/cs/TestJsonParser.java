...
public class TestJsonParser {
    ...
    public void testGetStandardItemNameFromSampleJson() throws IOException {
        ...
        JSONArray sampleJsonArray = testParser.parseStandardItemName(JsonToString.readJsonAsString(testInputStream));
    ...
    public void testGetStatsFromSampleJson() throws IOException {
        InputStream testInputStream = getWeaponItemJsonFile();
        JSONArray sampleJsonArray = testParser.parseStandardItemResults(JsonToString.readJsonAsString(testInputStream));
    ...
    public void testGetDescriptionFromSampleJson() throws IOException {
        InputStream testInputStream = getMagicItemJsonFile();
        JSONArray sampleJsonArray = testParser.parseMagicItemDescription(JsonToString.readJsonAsString(testInputStream), 0);
